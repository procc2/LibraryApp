...
import 'package:libraryapp/widgets/description_text.dart';
import 'package:libraryapp/widgets/download_alert.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<DetailsProvider>(
      builder: (BuildContext context, DetailsProvider detailsProvider,
          Widget child) {
        return detailsProvider.isLoading()
            ? Center(
                    ...
                    IconButton(
                      onPressed: () {
                        Share.text(
                          ...
                          "Read/Download ${entry.title.t} from this app.",
                          "text/plain",
                        );
                      },
                      icon: Icon(
                  ...
                  children: <Widget>[
                        ...
                        children: <Widget>[
                          Hero(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: "${entry.files.isNotEmpty ? entry.files.single.title : null}",
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                detailsProvider.entryCategory.feed == null
                                    ? SizedBox()
                                    : Container(
                                        height: detailsProvider
                                                    .entryCategory.feed.length <
                                                3
                                            ? 40
                                            : 80,
                                        child: GridView.builder(
                                          ...
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            EntryCategory cat = detailsProvider
                                                .entryCategory.feed[index];
                    ...
                    detailsProvider.loading
                        ...
                        : ListView.builder(
                            ...
                            itemCount:
                                detailsProvider.related.feed.entry.length,
                            itemBuilder: (BuildContext context, int index) {
                              Entry entry =
                                  detailsProvider.related.feed.entry[index];
                              return Padding(
